...
begin
  ...
  me as (
    select
      ...
      pref.preferred_intents[1]::public.profile_intent as primary_intent
  ...
  base_candidates as (
    select
      ...
      p.city,
      null::text as bio,
      pref_t.preferred_intents[1]::public.profile_intent as intent,
      p.languages,
      p.birth_date,
      p.avatar_url,
      null::text[] as photo_urls,
      p.last_active_at,
      p.created_at,
    ...
    where p.user_id <> v_actor
      ...
      and (
        ...
        or pref_t.preferred_intents[1] = any (me.preferred_intents)
      )
      and (
      ...
      and (
        ...
        or me.primary_intent is null
        or me.primary_intent = any (pref_t.preferred_intents)
      )
      and (
  ...
  scored as (
    select
      ...
      max(s.score)::double precision as score,
